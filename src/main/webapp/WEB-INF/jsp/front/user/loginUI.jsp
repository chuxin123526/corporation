...
border-radius:13px;box-shadow: 5px 5px 5px #D0DFEF;">
			...
			<form method = "post" action = "../user/login" id = "userForm" class="form-horizontal" role="form">
				<div class="form-group">
					<label for="userName" class="col-md-3 control-label">用户名</label>
					<div class="col-md-8">
						<input type="text" class="form-control" value = "somebody" name = "userName" id="userName" required minlength = "6" maxlength = "16"
							placeholder="请输入用户名">
				...
				<div class="form-group">
					...
					<div class="col-md-8">
						<input type="password" name = "password" value = "somebody" class="form-control" id="password"  required minlength = "6" maxlength = "16"
							placeholder="请输入密码">
				...
				<div class="form-group">
					...
					<a href = "../user/forgetPasswordUI" style = "color : #CC0000 ;">忘记密码?</a>
		</div>
...
$(document).ready(function() {
	...
	//validate自定义方法:checkCodeType 使用字母、数字、下划线，需以字母开头
            		...
            		if(result.responseCode == 1)
            			{
            				//验证用户名和密码
	            			$.ajax({ 
	                        	url: "../user/checkByUserNameAndPassword",
	                            type: "post",
	                            dataType: "json",
